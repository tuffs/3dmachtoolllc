  ...
  return (
    <>
      ...
      <div className="mt-24 text-gray-400 pt-0 p-8">
        ...
        <section className="mb-12">
          <h3 className="text-xl font-semibold mb-4">Capabilities with the HAAS TL-1 Lathe</h3>
        ...
        <section className="mb-12">
          <h3 className="text-xl font-semibold mb-4">Capabilities with the JET JDP-20EVS-110 Drill Press</h3>
          <div className="space-y-4">
            <div>
        ...
        <section className="mb-12">
          <h3 className="text-xl font-semibold mb-4">Capabilities with the Cloudray Laser Etcher</h3>
          <div className="space-y-4">
            <div>
        ...
        <section className="mb-12">
          <h3 className="text-xl font-semibold mb-4">Extended Capabilities</h3>
          <div className="space-y-4">
            <div>
        ...
        <section className="mb-12">
          <h3 className="text-xl font-semibold mb-4">Comprehensive Production Capabilities</h3>
          <div className="space-y-4">
            <div>
        ...
        <footer className="mt-12 border-t border-gray-700 pt-8">
          <p className="mb-2">
            For quotations or inquiries, please contact <strong>Devon Kiss</strong> at <strong>(448)-256-6963</strong> or via email at{' '}
            <a href="mailto:devon@3dmandt.com" className="text-blue-400 hover:underline">devon@3dmandt.com</a>.
          </p>
          <p>
            For large file attachments (over 15 Mb), please use a file upload service like Google Drive or Dropbox.
          </p>
        </footer>
      </div>
    </>
